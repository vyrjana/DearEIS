...
.. note::
   ...
   Python 3.11 or 3.12, and DearPyGui 1.x are strongly recommended.
   However, since DearPyGui 1.x is not available for Python 3.13 and later, version 2.x is installed instead in that scenario.
