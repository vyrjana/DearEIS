...
class SubtractImpedance:
        ...
        with dpg.child_window(
            ...
            with dpg.group(horizontal=True):
                ...
                with dpg.group():
                    ...
                    self.fit_group: Tag = dpg.generate_uuid()
                    with dpg.group(horizontal=True, tag=self.fit_group):
                        self.fit_combo: Tag = dpg.generate_uuid()
                        dpg.add_combo(
                        ...
                        self.copy_circuit_button: Tag = dpg.generate_uuid()
                        dpg.add_button(
                            label="Copy",
                    ...
                    self.spectrum_group: Tag = dpg.generate_uuid()
                    with dpg.group(horizontal=True, tag=self.spectrum_group):
                        self.spectrum_combo: Tag = dpg.generate_uuid()
                        dpg.add_combo(
                            items=self.data_labels,
                            default_value=(
                                self.data_labels[0] if self.data_labels else ""
                            ),
                            width=405,
    ...
    def copy_circuit(self):
        ...
        self.circuit_editor.show(fit.circuit, data=self.data)
