...
class TestUtility(TestCase):
    ...
    def test_02_version_1(self):
        ...
        # - data sets
        datasets: List[DataSet] = project.get_datasets()
    ...
    def test_03_version_2(self):
        ...
        self.assertEqual(type(series.get_data()), list)
        self.assertEqual(len(series.get_data()), 2)
        self.assertTrue(all(map(lambda _: type(_) is ndarray and len(_.shape) == 1, series.get_data())))
